...
public class OrgClient {
    private final int buin;
    private final String host;
    private final String appId;
    private final String appAeskey;
    ...
    private List<Department> parseDeptList(JsonObject jsonObj) {
        ...
        for(JsonElement e : jDeptArray){
            ...
            department.setDepartmentId((long) Helper.getInt("id",jDept));
            department.setDepartmentName(Helper.getString("name",jDept));
            department.setDepartmentSortId(Helper.getInt("sortId",jDept));
    ...
    // 获取部门直属子部门列表
    public List<Department> listDeptChildren(int deptId) throws ParamParserException, HttpRequestException, AESCryptoException {
    ...
    // 获取部门下所有子部门，传0获取所有部门
    public List<Department> listDeptAllChildren(int deptId) throws ParamParserException, HttpRequestException, AESCryptoException {
    ...
    //获取部门及直属子部门列表
    public List<Department> listDeptSelfAndChildren(int deptId) throws ParamParserException, HttpRequestException, AESCryptoException {
